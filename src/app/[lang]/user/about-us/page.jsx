            ...
            <div className="bg-white ">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    ...
                    <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                        <div className="shadow-lg rounded-3xl transform hover:scale-105 transition-transform duration-300 text-center hover:shadow-slate-400 text-gray-500 dark:text-gray-400 py-7 group">
                            <Image
